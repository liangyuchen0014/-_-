...
urlpatterns = [
    ...
    path('repairReport', repair_report),
    path('myRepair', my_repair),
    path('repairService', repair_service),
    path('repairDetail', repair_detail),
    path('repairComplete', repair_complete),
    path('setMaintainer', set_maintainer),
    path('repairList', repair_list),
